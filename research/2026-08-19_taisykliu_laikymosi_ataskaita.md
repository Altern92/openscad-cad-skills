...
|---|---|---|---|---|---|
| A-001 | ~~CoVe paper~~ CORREGE 2026-08-19: šis ID iš tikrųjų yra DISC (Denoising Iterative Self-Correction, Yin/Ken/Stremmel, Thomson Reuters Labs) -- CoVe jame tėra palyginimo baseline, kurį DISC superina. Žr. ištaisytą versiją `rules_enforcement.md` E-001. | https://arxiv.org/abs/2606.21724 ; https://aclanthology.org/2025.bionlp-share.34/ | pirminis | 2026-08-19 | ⚠️ buvo klaidingai pavadinta, ištaisyta |
...
Problemą apibūdina trys patvirtintos priežastys, kodėl agentai nukrypsta nuo taisyklių: **konteksto perkrova** — taisyklės „nuskęsta" ilgoje SKILL.md; **nėra pasekmių** — praleidus žingsnį niekas nesustoja; ir **taisyklė nėra patikrinama mašinai** — „privaloma atlikti X" be mechanizmo įrodyti, kad X tikrai įvyko. Vienas „būk atsargus" promptas šioms problemoms nepadeda — modelis gali pasirodyti sekąs, bet be deterministinio patikrinimo tai tik imitacija. Literatūra tai patvirtina: iteratyvios verify-judge-correct kilpos mažina LLM klaidas ([DISC, arxiv 2606.21724](https://arxiv.org/abs/2606.21724) -- superina CoVe kaip baseline'ą; ankstesnė šio dokumento versija klaidingai vadino šį darbą "CoVe paper", ištaisyta 2026-08-19), struktūruoti rezultatai ir veiksmų apribojimai būtini patikimiems agentams ([BeFailProof](https://befailproof.ai/guides/how-to-make-ai-agents-reliable/), [Gemma 4 guardrails](https://dev.to/system_rationale/part-3-making-gemma-4-agents-production-ready-guardrails-structured-outputs-and-self-healing-575n)), o gamybiniams agentams neužtenka promptų — reikia būsenos mašinos ir vartų ([Production AI agents](https://www.mygreatlearning.com/blog/production-ai-agents/)).
